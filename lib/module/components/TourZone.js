...
export const TourZone = ({
  ...
  }, [stepKey, name, description, order, borderRadius, registerStep, unregisterStep, clickable, preventInteraction, required, completed, resolvedSpotlightStyle, renderCustomCard]);
